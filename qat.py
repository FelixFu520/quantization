...
# -------------------------- Dataset ------------------------------	
train_path = "./data/wafer_train.txt"
train_set = segDataset(train_path, transforms=None)
test_path = "./data/wafer_val.txt"
...
if __name__ == "__main__":
    for epoch in range(Start_epoch, NUM_EPOCH):	
        ...
        torch.save(model.state_dict(), "./checkpoints/{}/qat_epoch_{:02}_loss_{:.6f}_ce_{:.6f}_dice_{:.6f}.pth".format(experment_name,epoch, all_loss, ce_loss, dice_loss),_use_new_zipfile_serialization=False)
